...
* [OAuth2 Authorization Server](https://docs.spring.io/spring-boot/docs/3.3.2/reference/htmlsingle/index.html#web.security.oauth2.authorization-server)
...
```
$ docker run --rm -p 8080:8080 auth-server:0.0.1-SNAPSHOT
```
