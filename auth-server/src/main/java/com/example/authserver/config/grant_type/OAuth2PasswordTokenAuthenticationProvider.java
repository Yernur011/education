package com.example.authserver.config.grant_type;
...
public class OAuth2PasswordTokenAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        try{
            log.info("Authenticating user: " + passwordAuthentication.getUsername());
            ...
            log.info("Authentication successful for user: " + passwordAuthentication.getUsername());
        } catch (BadCredentialsException e) {
            log.error("Failed to authenticate user: " + passwordAuthentication.getUsername(), e);
