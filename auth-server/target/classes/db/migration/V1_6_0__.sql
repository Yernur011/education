...
ALTER TABLE course_lessons
    ADD CONSTRAINT uc_course_lessons_lessons UNIQUE (lessons_id);
...
ALTER TABLE course_lessons
    ADD CONSTRAINT fk_coules_on_course FOREIGN KEY (course_id) REFERENCES course (id);

ALTER TABLE course_lessons
    ADD CONSTRAINT fk_coules_on_lesson FOREIGN KEY (lessons_id) REFERENCES lesson (id);
...
ALTER TABLE course_users
    ADD CONSTRAINT fk_couuse_on_user_entity FOREIGN KEY (users_user_id) REFERENCES sso.users (user_id);
